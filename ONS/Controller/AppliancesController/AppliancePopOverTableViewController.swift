//
//  AppliancePopOverTableViewController.swift
//  ONS
//
...
protocol AppliancePopOverProtocol {
    func didSelectItem(index: Int)
}

class AppliancePopOverTableViewController: UITableViewController {

    var popOverArray = [String]()
    var delegate : AppliancePopOverProtocol?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = self.popOverArray[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.delegate?.didSelectItem(index: indexPath.row)
